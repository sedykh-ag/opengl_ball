...
class CalcMesh:
    ...
    def snapshot(self, snap_number):
        ...
        writer.SetFileName("amongus-step-" + str(snap_number) + ".vtu")
        writer.Write()
...
try:
    ...
    gmsh.merge(os.path.join(path, 'amongus_half.stl'))
except:
